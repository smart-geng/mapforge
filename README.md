...
方案与决策见 [docs/地图格式转换工厂-首批三格式方案.md](docs/地图格式转换工厂-首批三格式方案.md)（当前 v1.26）；
...
.venv/Scripts/python -m pytest tests -q          # 68 项（含金凤黄金回归与 G8 故障注入）
.venv/Scripts/python scripts/closed_loop.py      # 14 文件 G1–G8 + esmini
```
