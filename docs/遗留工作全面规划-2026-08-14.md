...
> **执行进展（2026-08-14，v1.25）**：本计划所列 R0-02、R0-03 的极小段/连接角/静默裁线/fallback 风险已解决；G7 已增加普通 leg ≥3m、connecting road ≥1m 的最终文件硬门禁，14/14 真实文件与 esmini 全绿，pytest 44/44。车道来源 provenance 和按 lane 配对的保真诊断/故障注入已落地，但 R0-04 所要求的“14 文件、两管道、双向保真正式 G8”仍未全部完成；当前工作也尚未拆分提交或配置 remote，因此 R0 整体不能标记完成。
...
| GUI-01 | P1 | 审阅 G0 线框 | FND-03 | 操作流程确认 |
| GUI-02 | P1 | G0 五屏操作台 | GUI-01,FND-03 | 本地 127.0.0.1、统一后端 |
